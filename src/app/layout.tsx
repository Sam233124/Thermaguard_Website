  ...
  return (
    <html lang="nl">
      <head>
        ...
        <link rel="apple-touch-icon" sizes="180x180" href="https://thermaguard.nl/images/thermaguard-logo.png" />
        <link rel="icon" type="image/png" sizes="32x32" href="https://thermaguard.nl/images/thermaguard-logo.png" />
        <link rel="icon" type="image/png" sizes="16x16" href="https://thermaguard.nl/images/thermaguard-logo.png" />
